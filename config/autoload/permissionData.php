...
return [
    'permission_list' => [
        ...
        [
            ...
            "display_name" => "系统建议",
            "display_desc" => "提供给用户反馈bug以及优化给技术",
        ...
        [
            "id"           => "59",
            "parent_id"    => "56",
            "name"         => "Api:blog/picture_module/album/detroy-detroy",
            "display_name" => "删除相册",
            "display_desc" => "删除相册操作",
            "url"          => "",
            "component"    => "",
        ...
        [
            "id"           => "61",
            "parent_id"    => "60",
            "name"         => "Api:blog/picture_module/photo/store-store",
            "display_name" => "添加图片",
            "display_desc" => "添加图片模块",
            "url"          => "",
            "component"    => "",
